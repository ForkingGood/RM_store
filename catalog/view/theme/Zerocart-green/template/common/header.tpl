...
if ($categories) {
	...
	$small_html = "<div class='small_cat'><div><img src='catalog/view/theme/Zerocart-green/image/menu2.png'/></div>
...
<?php if ($error) { ?>
    ...
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/Zerocart-green/image/close.png" alt="" class="close" /></div>
